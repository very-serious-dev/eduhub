...
const TextAreaWithLimit = (props) => {
    ...
    const isRequired = props.allowEmptyContent ? false : true;
    ...
    return <div className="textAreaContainer">
        <textarea value={props.value}
            ...
            onFocus={e => { if (props.placeholder === undefined) { e.target.placeholder = "Puedes poner texto en *negrita* si lo rodeas con *asteriscos*, o en _cursiva_, si usas _barras bajas_.\nTambién puedes mostrar listas comenzando tus párrafos con un guión:\n- Uno\n- Dos\n- Tres"; }}}
            onBlur={e => { if (props.placeholder === undefined) { e.target.placeholder = defaultPlaceholder; }}} required={isRequired} />
