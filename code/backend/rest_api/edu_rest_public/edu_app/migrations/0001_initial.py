# Generated by Django 5.1.7 on 2025-07-28 18:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('parent_folder', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='edu_app.folder')),
            ],
        ),
        migrations.AddField(
            model_name='document',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archived', models.BooleanField(default=False)),
                ('student_group', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='edu_app.group')),
            ],
        ),
        migrations.AddField(
