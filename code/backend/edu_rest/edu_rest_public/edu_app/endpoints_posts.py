...
def create_post(request, classId):
    if request.method == "POST":
        ...
        if json_title is None or json_content is None or json_files is None or json_post_type is None:
            return JsonResponse({"error": "Falta title, content, files o post_type en el cuerpo de la petición"}, status=400)
